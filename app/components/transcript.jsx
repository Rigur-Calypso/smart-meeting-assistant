...
export function TranscriptPanel() {
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Header */}
      <div className="px-6 py-5 border-b border-red-700 bg-linear-to-r from-yellow-800 to-yellow-750">
      ...
      {/* Transcript List */}
      <div className="flex-1 overflow-y-auto px-6 py-4 space-y-3 bg-blue-850 custom-scrollbar">
        {transcripts.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center px-4">
            <div className="relative mb-6">
              <div className="w-20 h-20 bg-red-700 rounded-full flex items-center justify-center">
                <svg
          ...
          <>
            {transcripts.map((transcript, idx) => (
              <div
                key={idx}
                className="group bg-gradient-to-br from-pink-700 to-gray-750 rounded-xl p-4 shadow-lg hover:shadow-xl transition-all duration-300 border border-red-600 hover:border-blue-500/50 transform hover:-translate-y-0.5"
              >
