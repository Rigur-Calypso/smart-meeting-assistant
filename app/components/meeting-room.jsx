    ...
    return (
      <div className="flex items-center justify-center min-h-screen text-white">
        <div className="text-center">
          <div className="animate-spin h-16 w-16 border-t-4 border-pink-500 mx-auto rounded-full" />
  ...
  return (
    <StreamTheme>
      <StreamCall call={call}>
        <div className="min-h-screen bg-gradient-to-br from-red-600 via-blue-500 to-yellow-200 text-white">
          <div className="container mx-auto px-4 py-6 h-screen">
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-6 h-full">
              <div className="flex flex-col gap-4">
                <div className="flex-1 rounded-xl bg-pink-800 border border-red-700 overflow-hidden shadow-2xl">
                  <SpeakerLayout />
                </div>

                <div className="flex justify-center pb-4">
                  <div className="bg-green-800 rounded-full px-8 py-4 border border-red-700 shadow-xl">
                    <CallControls onLeave={handleLeaveClick} />
                  </div>
                </div>
              </div>

              <div className="bg-purple-800 rounded-2xl border border-yellow-700 overflow-hidden shadow-2xl">
                <TranscriptPanel />
              </div>
            </div>
          </div>
